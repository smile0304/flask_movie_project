...
class Tag(db.Model):
    ...
    movies = db.relationship("Movie",backref='tag') #电影外检关系关联
    def __repr__(self):
...
class Movie(db.Model):
    ...
    star = db.Column(db.SmallInteger)#星界
    ...
    movicecol = db.relationship('Movicecol', backref='movie')  # 收藏外键关联
    def __repr__(self):
